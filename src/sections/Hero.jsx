    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 ">
        ...
        <h1 className="mt-6 font-poppins text-[70px] max-sm:text-[50px] max-sm:leading-[82] font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-5 rounded-[15px]">
            The all brand new
          </span>{" "}
          <br />
          <span className="text-blue-500 inline-block">iPhone 16</span>
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-5 rounded-[20px]">
            {" "}
            Series
          </span>
        </h1>
        <p className="font-poppins text-lg mt-5 mb-5">
          The stylish and the most innovative iPhone of all the time
        </p>
